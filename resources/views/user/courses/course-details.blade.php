				...
				<div class="row">
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det mb-4">
									<a href="#" class="text-dark"><h3 class="font-weight-semibold">Online Training Classes Available For You</h3></a>
									<div class=" d-flex">
						...
						<div class="card">
								...
								<div class="row">
									...
									<div class="col-xl-6 col-md-12">
										<ul class="list-unstyled widget-spec mb-0">
											...
											<li class="">
												<i class="fa fa-laptop text-muted w-5"></i> 24 Hours Lab Providing
											</li>
											<li class="">
							...
							<div class="card-footer">
								<div class="icons">
									...
									<a href="#" class="btn btn-secondary mb-3 mb-xl-0 icons"><i class="icon icon-share mr-1"></i> Share Course</a>
									<a href="#" class="btn btn-info mb-3 mb-xl-0 icons" data-toggle="modal" data-target="#report"><i class="icon icon-exclamation mr-1"></i> Report Abuse</a>
							...
							<div class="card-body p-0">
								<div class="media mt-0 p-5">
                                    ...
                                    <div class="media-body">
										...
										<a href="" class="mr-2" data-toggle="modal" data-target="#Comment"><span class="badge badge-default">Comment</span></a>
										<a href="" class="mr-2" data-toggle="modal" data-target="#report"><span class="badge badge-default">Report</span></a>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card">
							<div class="card-body">
								<div class="mb-5">
									<div class="text-dark mb-2"><span class="text-dark font-weight-semibold h1">$135</span>
										<span class="text-muted h3 font-weight-normal ml-1"><span class="strike-text">$155</span></span>
									</div>

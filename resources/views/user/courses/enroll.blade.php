...
@guest
<section class="sptb">
<div class="text-center text-primary" style="position:relative;top:-20px"><a href="{{route('login')}}">Already Member ?</a></div>
			<div class="container">
				<div class="row ">
								...
								<div class="tab-content card-body border mb-0 b-0">
									...
									<div class="form-group row clearfix">
										<div class="col-lg-12">
											...
											<button type="submit" class="btn btn-success  mb-0 mr-2">Continue</button>
									</div>
									</form>
								</div>
							</div>
